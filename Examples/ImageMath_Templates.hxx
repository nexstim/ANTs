...
ANTSGetFilePrefix(const char * str)
{
...
static inline std::string
ANTSOptionValue(const char * str)
{
  std::string            filename = str;
  std::string::size_type pos = filename.rfind("=");
...
static inline std::map<unsigned int, std::string>
RoiList(std::string file)
{
...
int
FrobeniusNormOfMatrixDifference(int argc, char * argv[])
{
  if (argc < 6)
  {
  ...
  typename AffineTransformType::MatrixType::InternalMatrixType diffmat =
    aff2->GetMatrix().GetVnlMatrix() - aff1->GetMatrix().GetVnlMatrix();
...
template <unsigned int ImageDimension>
void
ClosestSimplifiedHeaderMatrix(int argc, char * argv[])
{
  if (argc < 4)
  {
...
template <unsigned int ImageDimension>
void
ReflectionMatrix(int argc, char * argv[])
{
  if (argc < 4)
  {
    std::cout << " need more args -- see usage   " << std::endl;
  ...
  std::string fn1 = std::string(argv[argct]);
  argct++;
  unsigned int axis = std::stoi(argv[argct]);
  argct++;
  typename ImageType::Pointer image1 = nullptr;
  ReadImage<ImageType>(image1, fn1.c_str());
...
template <unsigned int ImageDimension>
void
MakeAffineTransform(int argc, char * argv[])
{
  if (argc < 3)
  {
    std::cout << " need more args -- see usage   " << std::endl;
...
template <unsigned int ImageDimension>
int
GetLargestComponent(int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
...
template <unsigned int ImageDimension>
int
ClusterThresholdVariate(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
  ...
  std::string fn1 = std::string(argv[argct]);
  argct++;
  std::string maskfn = std::string(argv[argct]);
  argct++;
...
template <unsigned int ImageDimension>
int
ExtractSlice(int argc, char * argv[])
{
  if (argc <= 2)
  {
  ...
  std::string fn1 = std::string(argv[argct]);
  argct++;
  unsigned int slice = std::stoi(argv[argct]);
  argct++;
...
template <unsigned int ImageDimension>
int
ThresholdAtMean(int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::ImageRegionIteratorWithIndex<ImageType> Iterator;
...
template <unsigned int ImageDimension>
int
SetTimeSpacing(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
...
template <unsigned int ImageDimension>
int
SetTimeSpacingWarp(int argc, char * argv[])
{
...
template <unsigned int ImageDimension>
int
FlattenImage(int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::ImageRegionIteratorWithIndex<ImageType> Iterator;
...
template <unsigned int ImageDimension>
int
TruncateImageIntensity(unsigned int argc, char * argv[])
{
  ...
  {
    std::cout << " need more args -- see usage   " << std::endl
              << " ImageMath 3 outimage.nii.gz  TruncateImageIntensity inputImage  {lowerQuantile=0.025} "
                 "{upperQuantile=0.975}  {numberOfBins=65}  {binary-maskImage} {copy-image-space-from-input-to-mask}"
              << std::endl;
    throw std::exception();
  }
  ...
  itk::ImageRegionIterator<RealImageType> ItI(image, image->GetLargestPossibleRegion());
  itk::ImageRegionIterator<ImageType>     ItM(mask, mask->GetLargestPossibleRegion());
...
TileImages(unsigned int argc, char * argv[])
{
  ...
  const std::string outname = std::string(argv[argct]);
  argct += 2;
  unsigned int nx = std::stoi(argv[argct]);
  argct++;
  ...
  unsigned int ny = static_cast<unsigned int>(static_cast<float>(numberofimages) / static_cast<float>(nx) + 0.5f);
  ...
  typename ImageType::Pointer tiledimage =
    AllocImage<ImageType>(region, image2->GetSpacing(), image2->GetOrigin(), image2->GetDirection());
...
template <unsigned int ImageDimension>
int
ConvertLandmarkFile(unsigned int argc, char * argv[])
{
  unsigned int argct = 2;
  ...
  const std::string outname = std::string(argv[argct]);
  argct += 2;
  std::string infn = std::string(argv[argct]);
  argct++;
  float pointp = 1;
...
template <unsigned int ImageDimension>
int
TriPlanarView(unsigned int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
...
template <unsigned int ImageDimension>
int
ConvertVectorToImage(unsigned int argc, char * argv[])
{
  typedef float                                              PixelType;
  typedef itk::Image<PixelType, ImageDimension>              ImageType;
  typedef itk::Image<PixelType, 2>                           MatrixImageType;
  ...
  std::string maskfn = std::string(argv[argct]);
  argct++;
  std::string vecfn = std::string(argv[argct]);
  argct++;
  typename ImageType::Pointer mask = nullptr;
  ReadImage<ImageType>(mask, maskfn.c_str());
...
template <unsigned int ImageDimension>
int
CorruptImage(int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::ImageRegionIteratorWithIndex<ImageType> Iterator;
  ...
  if (argc > argct)
  {
    noiselevel = atof(argv[argct]);
    argct++;
  }
  float smoothlevel = 1.0;
  if (argc > argct)
  {
    smoothlevel = atof(argv[argct]);
    argct++;
  }
...
template <unsigned int ImageDimension>
int
SetOrGetPixel(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
  ...
  argct++;
  float       value = atof(argv[argct]);
  std::string Get = std::string(argv[argct]);
  argct++;
  float indx = atof(argv[argct]);
  argct++;
  float indy = 0;
  if (ImageDimension >= 2)
  {
    indy = atof(argv[argct]);
    argct++;
  }
  float indz = 0;
  if (ImageDimension >= 3)
  {
    indz = atof(argv[argct]);
    argct++;
  }
  bool usephyspace = false;
  if (argc > argct)
  {
    usephyspace = std::stoi(argv[argct]);
    argct++;
  }
  bool get = false;
...
template <unsigned int ImageDimension>
int
HistogramMatching(int argc, char * argv[])
{
  typedef float                                                   PixelType;
  typedef itk::Image<PixelType, ImageDimension>                   ImageType;
...
template <unsigned int ImageDimension>
int
RescaleImage(int argc, char * argv[])
{
  if (argc < 7)
  {
    // std::cout << " need more args -- see usage   " << std::endl;
...
template <unsigned int ImageDimension>
int
WindowImage(int argc, char * argv[])
{
  if (argc < 9)
  {
    // std::cout << " need more args -- see usage   " << std::endl;
...
PadImage(int argc, char * argv[])
{
  ...
  typename ImageType::Pointer padimage =
    AllocImage<ImageType>(newregion, image1->GetSpacing(), origin2, image1->GetDirection(), padVoxelValue);
...
template <unsigned int ImageDimension>
int
SigmoidImage(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
...
template <unsigned int ImageDimension>
int
CoordinateComponentImages(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
...
template <unsigned int ImageDimension>
int
SharpenImage(int argc, char * argv[])
{
  if (argc < 5)
  {
...
template <unsigned int ImageDimension>
int
UnsharpMaskImage(int argc, char * argv[])
{
  if (argc < 5)
  {
    // std::cout << "Error.  Not enough arguments.  See help menu." << std::endl;
...
template <unsigned int ImageDimension>
int
CenterImage2inImage1(int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::ImageRegionIteratorWithIndex<ImageType> Iterator;
  ...
  double                        iweight = 0;
  typename ImageType::PointType cm_point;
  cm_point.Fill(0);
...
template <unsigned int ImageDimension>
int
TimeSeriesMask(int argc, char * argv[])
{
...
template <unsigned int ImageDimension>
int
TimeSeriesDisassemble(int argc, char * argv[])
{
  if (argc <= 4)
  {
    // std::cout << " too few options " << std::endl;
...
template <unsigned int ImageDimension>
int
TimeSeriesAssemble(int argc, char * argv[])
{
  if (argc <= 6)
  {
    // std::cout << " too few options " << std::endl;
  ...
  const std::string outname = std::string(argv[argct]);
  argct += 2;
  float time = atof(argv[argct]);
  argct++;
  float origin = atof(argv[argct]);
  argct++;
...
template <unsigned int ImageDimension>
int
TimeSeriesSubset(int argc, char * argv[])
{
  if (argc <= 2)
  {
    // std::cout << " too few options " << std::endl;
  ...
  std::string fn1 = std::string(argv[argct]);
  argct++;
  unsigned int n_sub_vols = std::stoi(argv[argct]);
  argct++;
...
template <unsigned int ImageDimension>
int
TimeSeriesSimpleSubtraction(int argc, char * argv[])
{
  typedef float                                     PixelType;
  typedef itk::Image<PixelType, ImageDimension>     InputImageType;
  typedef itk::Image<PixelType, ImageDimension - 1> OutputImageType;

  typedef itk::AlternatingValueSimpleSubtractionImageFilter<InputImageType, InputImageType> ImageFilterType;
  typedef itk::AverageOverDimensionImageFilter<InputImageType, OutputImageType>             MeanFilterType;
...
template <unsigned int ImageDimension>
int
TimeSeriesInterpolationSubtraction(int argc, char * argv[])
{
  typedef float                                     PixelType;
  typedef itk::Image<PixelType, ImageDimension>     InputImageType;
  typedef itk::Image<PixelType, ImageDimension - 1> OutputImageType;

  typedef itk::AlternatingValueDifferenceImageFilter<InputImageType, InputImageType> ImageFilterType;
  typedef itk::AverageOverDimensionImageFilter<InputImageType, OutputImageType>      MeanFilterType;
...
template <unsigned int ImageDimension>
int
SplitAlternatingTimeSeries(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;

  typedef itk::SplitAlternatingTimeSeriesImageFilter<ImageType, ImageType> ImageFilterType;
...
template <unsigned int ImageDimension>
int
SliceTimingCorrection(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> InputImageType;
  ...
  if (argc < 5)
  {
    std::cout << "Usage: ImageMath 4 out.nii.gz SliceTimingCorrection input.nii.gz [sliceTiming] [sinc/bspline] "
  ...
  if (sliceTiming * static_cast<float>(image1->GetLargestPossibleRegion().GetSize()[ImageDimension - 2]) >
      static_cast<float>(image1->GetSpacing()[ImageDimension - 1]))
  {
...
template <unsigned int ImageDimension>
int
AverageOverDimension(int argc, char * argv[])
{
  typedef float                                     PixelType;
  typedef itk::Image<PixelType, ImageDimension>     ImageType;
  typedef itk::Image<PixelType, ImageDimension - 1> AverageImageType;

  typedef itk::AverageOverDimensionImageFilter<ImageType, AverageImageType> ImageFilterType;
...
template <unsigned int ImageDimension>
int
TimeSeriesRegionSCCA(int argc, char * argv[])
{
  typedef float                                    PixelType;
  typedef itk::Image<PixelType, ImageDimension>    InputImageType;
...
template <unsigned int ImageDimension>
int
TimeSeriesRegionCorr(int argc, char * argv[])
{
  typedef float                                    PixelType;
  typedef itk::Image<PixelType, ImageDimension>    InputImageType;
  typedef itk::Image<unsigned int, ImageDimension> LabelImageType;
...
template <unsigned int ImageDimension>
int
PASLQuantifyCBF(int argc, char * argv[])
{
  typedef float                                     PixelType;
...
template <unsigned int ImageDimension>
int
PCASLQuantifyCBF(int argc, char * /*NOT USED argv*/[])
{
  if (argc < 6)
  {
    return EXIT_FAILURE;
  ...
  FilterType; int         argct = 2; std::string outname = std::string(argv[argct++]); std::string operation =
  std::string(argv[argct++]); std::string fn1 = std::string(argv[argct++]); std::string m0name =
  std::string(argv[argct++]);
...
template <unsigned int ImageDimension>
int
ComputeTimeSeriesLeverage(int argc, char * argv[])
{
  if (argc <= 2)
  {
    // std::cout << " too few options " << std::endl;
  ...
  std::string fn1 = std::string(argv[argct]);
  argct++;
  unsigned int k_neighbors = std::stoi(argv[argct]);
  argct++;
  typename ImageType::Pointer image1 = nullptr;
  if (fn1.length() > 3)
  {
...
template <unsigned int ImageDimension>
int
TimeSeriesToMatrix(int argc, char * argv[])
{
  if (argc <= 2)
  {
    // std::cout << " too few options " << std::endl;
  ...
  if (tomha)
    matriximage = AllocImage<MatrixImageType>(newregion, 0);
...
PASL(int argc, char * argv[])
{
  ...
  std::string fn1 = std::string(argv[argct]);
  argct++;
  bool firstiscontrol = std::stoi(argv[argct]);
  argct++;
  std::string m0fn = "";
  if (argc > argct)
  {
  ...
  {
    haveM0 = false;
    std::cout << "Warning: using calculatedM0 as reference M0 value --- see see 'Impact of equilibrium magnetization "
  ...
  for (vfIter2.GoToBegin(); !vfIter2.IsAtEnd(); ++vfIter2)
  {
    ...
    float M_0 = static_cast<float>(M0image->GetPixel(ind)); // FIXME can be taken from an input reference image or
...
pCASL(int argc, char * argv[])
{
  ...
  {
    haveM0 = false;
    std::cout << "Warning: using calculated value as reference M0 value --- see see 'Impact of equilibrium "
  ...
  for (vfIter2.GoToBegin(); !vfIter2.IsAtEnd(); ++vfIter2)
  {
    ...
    if (getCBF)
    {
      for (unsigned int t = 0; t < timedims; t++)
      {
        ...
        Cerebral blood flow in mL per 100g per minute was calculated pixel-by-pixel using equation (1), where the PLD
        was taken to be longer than ATT, reducing to (Wang et al, 2002), CBF =  \frac{      \lambda DeltaM     }  { 2
        alpha M_0 T_1a [ exp( - w / T_1a ) - exp( - ( tau + w ) / T_1a )  ] } w of 0.7seconds was determined based on
        the results of experiment (1) for optimal contrast of the GM. Cerebral blood flow was calculated for a single
        PLD. Quantitative CBF for the whole brain, GM, and WM were tabulated. The bottom slice was excluded from this
        analysis because it covered only a small part of the cerebrum.
           */
          ...
          // PASL 0.7.
          // from PMC3049525
          const RealType scaling =
            4 * alpha * static_cast<RealType>(M_0) * T_1t * (exp(-1.0 * (tau + w) / T_1a) - exp(-1.0 * w / T_1t));
...
MTR(int argc, char * argv[])
{
  ...
  typename ImageType::Pointer MTR = AllocImage<ImageType>(M0, 0);
...
template <unsigned int ImageDimension>
int
CompCorrAuto(int argc, char * argv[])
{
  if (argc <= 2)
  {
    // std::cout << " too few options " << std::endl;
  ...
  std::string fn1 = std::string(argv[argct]);
  argct++;
  std::string fn_label = std::string(argv[argct]);
  argct++;
...
template <unsigned int ImageDimension>
int
ThreeTissueConfounds(int argc, char * argv[])
{
  if (argc <= 2)
  {
    // std::cout << " too few options " << std::endl;
...
template <unsigned int ImageDimension>
int
Stack2Images(int argc, char * argv[])
{
  if (argc <= 2)
  {
    // std::cout << " too few options " << std::endl;
  ...
  typedef itk::TileImageFilter<ImageType, ImageType> TileImageFilterType;
  typename TileImageFilterType::Pointer              tileFilter = TileImageFilterType::New();
...
MakeImage(int argc, char * argv[])
{
  ...
  const std::string outname = std::string(argv[argct]);
  argct += 2;
  unsigned int sizevalx = std::stoi(argv[argct]);
  argct++;
  unsigned int sizevaly = 0;
  if (argc > argct)
  {
    sizevaly = std::stoi(argv[argct]);
    argct++;
  }
  unsigned int sizevalz = 0;
  if (argc > argct && ImageDimension > 2)
  {
    sizevalz = std::stoi(argv[argct]);
    argct++;
  }
...
template <unsigned int ImageDimension>
int
LabelSurfaceArea(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
            ...
            if ( p > 0 && radimage->GetPixel(ind) <= 0  )
          {
            for (unsigned int i = 0; i < GHood.Size(); i++)
                ...
                if ( GHood.GetPixel(i) == p && dist <= tardist)
              {
                ...
                //          // std::cout << " Ind " <<  ind << " : " <<  bestrad << " tardist " << tardist << " gct " <<
    goodct <<" pos " << possct << " dist " << dist << " ind2 " << ind2 << std::endl;
              }
            if (goodct==possct)
              {
...
ImageMath(int argc, char * argv[])
{
  ...
  if (strcmp(operation.c_str(), "mresample") == 0 && !isfloat)
  {
    ...
    typename ImageType::IndexType zeroind;
    zeroind.Fill(0);
...
template <unsigned int ImageDimension>
int
FuseNImagesIntoNDVectorField(int argc, char * argv[])
{
  typedef itk::Vector<float, ImageDimension>           VectorType;
  typedef itk::Image<VectorType, ImageDimension>       FieldType;
  typedef itk::Image<float, ImageDimension>            ImageType;
  ...
  if (fn2.length() > 3)
    ReadImage<ImageType>(image2, fn2.c_str());
  if (fn3.length() > 3)
    ReadImage<ImageType>(image3, fn3.c_str());
  typename FieldType::Pointer vimage = AllocImage<FieldType>(
    image1->GetLargestPossibleRegion(), image1->GetSpacing(), image1->GetOrigin(), image1->GetDirection());
...
template <unsigned int ImageDimension>
int
SmoothTensorImage(int argc, char * argv[])
{
  typedef float                                  ValueType;
  typedef itk::DiffusionTensor3D<ValueType>      TensorType;
  typedef itk::Image<TensorType, ImageDimension> TensorImageType;

  typedef itk::RecursiveGaussianImageFilter<TensorImageType, TensorImageType> GaussianFilterType;
...
template <unsigned int ImageDimension>
int
TensorFunctions(int argc, char * argv[])
{
  typedef float PixelType;
  ...
  if (strcmp(operation.c_str(), "ExtractComponentFrom3DTensor") == 0)
  {
    ...
    typename ImageType::Pointer componentImage = AllocImage<ImageType>(timage, 0.0);
  ...
  {
    cimage = AllocImage<ColorImageType>(timage);
  ...
  else if (strcmp(operation.c_str(), "TensorToVector") == 0)
  {
    ...
    vecimage = AllocImage<VectorImageType>(timage, zero);
           ...
           (strcmp(operation.c_str(), "TensorToLocalSpace") == 0) || (strcmp(operation.c_str(), "ValidTensor") == 0))
  {
    typename TensorImageType::PixelType zero;
    zero.Fill(0);
    toimage = AllocImage<TensorImageType>(timage, zero);
  ...
  {
    // std::cout << "Setting background voxels to isotropic tensors with mean diffusivity " << backgroundMD <<
    // std::endl;
  ...
  else if (strcmp(operation.c_str(), "TensorToVector") == 0)
  {
    ANTs::WriteImage<VectorImageType>(vecimage, outname.c_str());
           ...
           (strcmp(operation.c_str(), "TensorToLocalSpace") == 0) || (strcmp(operation.c_str(), "TensorMask") == 0) ||
...
template <unsigned int ImageDimension>
int
CompareHeadersAndImages(int argc, char * argv[])
{
  typedef float PixelType;
  //  const unsigned int ImageDimension = AvantsImageDimension;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  ...
  if (samesize)
  {
    ...
    for (vfIter2.GoToBegin(); !vfIter2.IsAtEnd(); ++vfIter2)
    {
      ...
      {
        pix2 = 0;
        image2->SetPixel(ind, 0);
      }
      //      float pix3=varimage->GetPixel(ind);
      float pix1 = image1->GetPixel(ind);
      if (pix1 > 0)
      {
        i1norm += static_cast<float>(fabs(pix1));
        ct1++;
      }
      if (pix2 > 0)
      {
        i2norm += static_cast<float>(fabs(pix2));
        ct2++;
      }
  ...
  if (orsignerr > 0)
  {
    ...
    for (unsigned int i = 0; i < ImageDimension; i++)
    {
      ...
      else if ((op1[i] > 0 && itk::Math::FloatAlmostEqual(op2[i], 0.0)) ||
               (op1[i] < 0 && itk::Math::FloatAlmostEqual(op2[i], 0.0)))
      {
...
template <unsigned int ImageDimension>
int
NegativeImage(int /*argc */, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef typename ImageType::IndexType                IndexType;
...
itkMRIBiasFieldCorrectionFilter(typename TImage::Pointer image,
                                typename TImage::Pointer labelimage,
                                unsigned int             sd = 2)
{
...
template <unsigned int ImageDimension>
int
ExtractContours(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
...
template <unsigned int ImageDimension>
int
FastMarchingSegmentation(unsigned int argc, char * argv[])
{
  unsigned int      argct = 2;
  const std::string outname = std::string(argv[argct]);
...
template <unsigned int ImageDimension>
int
PropagateLabelsThroughMask(int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::ImageRegionIteratorWithIndex<ImageType> Iterator;
  ...
  if (argc > argct)
  {
    stopval = atof(argv[argct]);
    argct++;
  }
  unsigned int topocheck = 0;
  if (argc > argct)
  {
    topocheck = std::stoi(argv[argct]);
    argct++;
  }
...
template <unsigned int ImageDimension>
int
FastMarchingExtension(int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::ImageRegionIteratorWithIndex<ImageType> Iterator;
  ...
  typedef itk::FastMarchingExtensionImageFilterBase<ImageType, ImageType, PixelType, 1> MarcherBaseType;
...
template <unsigned int ImageDimension>
int
itkPropagateLabelsThroughMask(int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::ImageRegionIteratorWithIndex<ImageType> Iterator;
...
template <unsigned int ImageDimension>
int
DistanceMap(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
...
template <unsigned int ImageDimension>
int
GenerateMaurerDistanceImage(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
...
template <unsigned int ImageDimension>
int
NormalizeImage(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
  ...
  if (useMaskImage)
  {
    ...
    itk::ImageRegionIterator<ImageType> It2(image, image->GetLargestPossibleRegion());
...
template <unsigned int ImageDimension>
int
GradientImage(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
...
template <unsigned int ImageDimension>
int
LaplacianImage(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
...
CannyImage(int argc, char * argv[])
{
  ...
  if (argc > argct)
  {
    lowerThreshold = atof(argv[argct]);
    argct++;
  }
  PixelType upperThreshold = -1.0;
  if (argc > argct)
  {
    upperThreshold = atof(argv[argct]);
    argct++;
  }
...
template <unsigned int ImageDimension>
int
PoissonDiffusion(int argc, char * argv[])
{
  if (argc < 6)
  {
    std::cout << "Usage error---not enough arguments.   See help menu." << std::endl;
    throw std::exception();
  }
    ...
    if (p > 0)
    {
      ...
      for (unsigned int i = 0; i < GHood.Size(); i++)
      {
        if (GHood.GetPixel(i) > 0 && !itk::Math::FloatAlmostEqual(GHood.GetPixel(i), p))
        {
          ...
          inda[0] = (long int)p;
          inda[1] = (long int)GHood.GetPixel(i);
          indb[1] = (long int)p;
          indb[0] = (long int)GHood.GetPixel(i);
...
template <unsigned int ImageDimension>
int
CountVoxelDifference(int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::ImageRegionIteratorWithIndex<ImageType> Iterator;
...
template <unsigned int ImageDimension>
int
DiceAndMinDistSum(int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::ImageRegionIteratorWithIndex<ImageType> Iterator;
  ...
  if (argc > argct)
  {
    outdistfn = std::string(argv[argct]);
    argct++;
  }
  ...
  unsigned int labct = 0;
  {
    ...
    for (It.GoToBegin(); !It.IsAtEnd(); ++It)
    {
      ...
      if (fabs(label) > 0)
      {
        if (find(myLabelSet2.begin(), myLabelSet2.end(), label) == myLabelSet2.end() &&
            find(myLabelSet1.begin(), myLabelSet1.end(), label) != myLabelSet1.end())
        {
  ...
  for (it = myLabelSet2.begin(); it != myLabelSet2.end(); ++it)
  {
    ...
    for (It2.GoToBegin(); !It2.IsAtEnd(); ++It2)
    {
      if (itk::Math::FloatAlmostEqual(It2.Get(), *it) ||
          itk::Math::FloatAlmostEqual(image1->GetPixel(It2.GetIndex()), *it))
      {
        countu++;
      }
      if (itk::Math::FloatAlmostEqual(It2.Get(), *it) &&
  ...
  newregion.SetSize(size);
  typename TwoDImageType::Pointer squareimage = AllocImage<TwoDImageType>(newregion, 0.0);

  typename TwoDImageType::Pointer squareimage2 = AllocImage<TwoDImageType>(newregion, 0.0);
...
Lipschitz(int argc, char * argv[])
{
  ...
  const std::string outname = std::string(argv[argct]);
  argct += 2;
  std::string vecname = std::string(argv[argct]);
  argct++;
  ...
  typename RealImageType::Pointer lipcon = AllocImage<RealImageType>(vecimage, 0);

  itk::TimeProbe timer;
  timer.Start();
  /** global Lipschitz points */
  typename VectorImageType::PointType gx;
  gx.Fill(0);
  typename VectorImageType::PointType gxt;
  gxt.Fill(0);
  typename VectorImageType::PointType gy;
  gy.Fill(0);
  typename VectorImageType::PointType gyt;
  gyt.Fill(0);
  typename VectorImageType::PointType lx;
  lx.Fill(0);
  typename VectorImageType::PointType lxt;
  lxt.Fill(0);
  typename VectorImageType::PointType ly;
  ly.Fill(0);
  typename VectorImageType::PointType lyt;
  lyt.Fill(0);
...
template <unsigned int ImageDimension>
int
ExtractVectorComponent(int argc, char * argv[])
{
  if (argc <= 2)
  {
    // std::cout << " too few options " << std::endl;
  ...
  const std::string                                   outname = std::string(argv[argct]);
  argct += 2;
  std::string inname = std::string(argv[argct]);
  argct++;
  unsigned int whichvec = std::stoi(argv[argct]);
  argct++;
  typedef itk::ImageFileReader<ImageType> ReaderType;
  ...
  {
    typename RealImageType::Pointer                      component = AllocImage<RealImageType>(vecimage, 0);
    typedef itk::ImageRegionIteratorWithIndex<ImageType> Iterator;
    Iterator                                             It1(vecimage, vecimage->GetLargestPossibleRegion());
    for (It1.GoToBegin(); !It1.IsAtEnd(); ++It1)
    {
...
InvId(int argc, char * argv[])
{
  ...
  const std::string outname = std::string(argv[argct]);
  argct += 2;
  std::string vecname1 = std::string(argv[argct]);
  argct++;
  std::string vecname2 = std::string(argv[argct]);
  argct++;
  ...
  typename RealImageType::Pointer invid = AllocImage<RealImageType>(vecimage1, 0);
...
template <unsigned int ImageDimension>
int
ReplicateDisplacement(int argc, char * argv[])
{
  if (argc > 6)
  {
  ...
  {
    // std::cout << "ImageMath 3 out4DWarp.nii.gz ReplicateDisplacement in3DWarp.nii.gz nreplications time-spacing
    // time-origin" << std::endl; std::cout << "ImageMath 3 out4DWarp.nii.gz ReplicateDisplacement in3DWarp.nii.gz
    // 10 2.5 0.0" << std::endl;
    return 1;
  }
  typedef float                                              RealType;
  ...
  std::string vecname1 = std::string(argv[argct]);
  argct++;
  unsigned int timedims = std::stoi(argv[argct]);
  argct++;
  RealType tr = atof(argv[argct]);
  argct++;
  RealType torigin = atof(argv[argct]);
  argct++;
  /**
   * Read in vector field
   */
...
template <unsigned int ImageDimension>
int
ShiftImageSlicesInTime(int argc, char * argv[])
{
  if (argc < 4)
  {
    return 1;
  ...
  if (argc > argct)
  {
    shiftamount = std::stoi(argv[argct]);
    argct++;
  }
  unsigned int shiftdim = ImageDimension - 1;
  if (argc > argct)
  {
    shiftdim = std::stoi(argv[argct]);
    argct++;
  }
  typename ImageType::Pointer image = nullptr;
  ReadImage<ImageType>(image, fn1.c_str());
...
template <unsigned int ImageDimension>
int
ReplicateImage(int argc, char * argv[])
{
  if (argc > 6)
  {
  ...
  {
    // std::cout << "ImageMath 3 out4D.nii.gz ReplicateImage in3D.nii.gz nreplications time-spacing time-origin" <<
    // std::endl; std::cout << "ImageMath 3 out4D.nii.gz ReplicateImage in3D.nii.gz 10 2.5 0.0" << std::endl;
    return 1;
  }
  typedef float                                        RealType;
  typedef itk::Image<RealType, ImageDimension>         ImageType;
  ...
  unsigned int timedims = std::stoi(argv[argct]);
  argct++;
  float tr = atof(argv[argct]);
  argct++;
  float torigin = atof(argv[argct]);
  argct++;
  typedef itk::ImageFileReader<ImageType> ReaderType;
  typename ReaderType::Pointer            reader1 = ReaderType::New();
  reader1->SetFileName(vecname1.c_str());
...
LabelStats(int argc, char * argv[])
{
  ...
  size[0] = size[1] = squareimagesize;
  newregion.SetSize(size);
  typename TwoDImageType::Pointer squareimage = AllocImage<TwoDImageType>(newregion, 0);
  ...
  for (it = myLabelSet.begin(); it != myLabelSet.end(); ++it)
  {
    ...
    else // if ( totalvolume > 500 &&  totalmass/totalct > 1/500 )  {
    {
      ...
      //      //      // std::cout << *it << "  " <<  totalvolume <<  " & " <<  totalmass/totalct   << " \ " <<
      //      std::endl;
    }
    ...
    if (ImageDimension == 2)
    {
      logfile << myCenterOfMass[0] << "," << myCenterOfMass[1] << ",0,0," << currentlabel << "," << totalmass << ","
              << totalvolume << "," << totalct << std::endl;
    }
    if (ImageDimension == 3)
    {
      logfile << myCenterOfMass[0] << "," << myCenterOfMass[1] << "," << myCenterOfMass[2] << ",0," << currentlabel
              << "," << totalmass << "," << totalvolume << "," << totalct << std::endl;
    }
    if (ImageDimension == 4)
    {
      logfile << myCenterOfMass[0] << "," << myCenterOfMass[1] << "," << myCenterOfMass[2] << "," << myCenterOfMass[3]
              << "," << currentlabel << "," << totalmass << "," << totalvolume << "," << totalct << std::endl;
    }
    labelcount++;
  }
...
template <unsigned int ImageDimension>
int
LabelThickness(int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::ImageRegionIteratorWithIndex<ImageType> Iterator;
...
template <unsigned int ImageDimension>
int
ROIStatistics(int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::ImageRegionIteratorWithIndex<ImageType> Iterator;
  ...
  argct += 2;
  std::string fn0 = std::string(argv[argct]);
  argct++;
  ...
  if (argc > argct)
  {
    fn4 = std::string(argv[argct]);
    argct++;
  }
  std::string fn5 = "";
  if (argc > argct)
  {
    fn5 = std::string(argv[argct]);
    argct++;
  }
    ...
    while (  (*it) != mylabel && it != myLabelSet.end() )
  {
    ...
    if (roi < roimap.size())
    {
      logfile << roimap[roi] << "," << roi + 1 << "," << clusters[roi + 1] << "," << masses[roi + 1] << ","
              << masses[roi + 1] / clusters[roi + 1] << "," << comx << "," << comy << "," << comz << "," << comt
              << std::endl;
    }
  }
  logfile.close();
...
template <unsigned int ImageDimension>
int
PValueImage(int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::ImageRegionIteratorWithIndex<ImageType> Iterator;
...
template <unsigned int ImageDimension>
int
ConvertImageSetToMatrix(unsigned int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::Image<PixelType, 2>                     MatrixImageType;
  ...
  std::string       ext = itksys::SystemTools::GetFilenameExtension(outname);
  argct += 2;
  unsigned int rowcoloption = std::stoi(argv[argct]);
  argct++;
  std::string maskfn = std::string(argv[argct]);
  argct++;
  unsigned int                numberofimages = 0;
...
template <unsigned int ImageDimension>
int
RandomlySampleImageSetToCSV(unsigned int argc, char * argv[])
{
  typedef float                                             PixelType;
  typedef itk::Image<PixelType, ImageDimension>             ImageType;
  ...
  std::string       ext = itksys::SystemTools::GetFilenameExtension(outname);
  argct += 2;
  unsigned int n_samples = std::stoi(argv[argct]);
  argct++;
...
template <unsigned int ImageDimension>
int
ConvertImageSetToEigenvectors(unsigned int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::ImageRegionIteratorWithIndex<ImageType> Iterator;
  ...
  argct += 2;
  unsigned int n_evecs = std::stoi(argv[argct]);
  argct++;
...
template <unsigned int ImageDimension>
int
ConvertImageToFile(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
  int                                           argct = 2;
...
template <unsigned int ImageDimension>
int
CorrelationUpdate(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
  int                                           argct = 2;
...
template <unsigned int ImageDimension>
int
MajorityVoting(int argc, char * argv[])
{
  typedef int                                           PixelType;
  typedef itk::Image<PixelType, ImageDimension>         ImageType;
  ...
  if (!doUsage1)
  {
    ...
    for (auto & fileExtension : fileExtensions)
    {
      ...
      {
        outputMaskName = outputName.insert(outputName.find_last_of(fileExtension) - fileExtension.length(), "_Mask");
        break;
      }
    }
...
template <unsigned int ImageDimension>
int
AverageLabels(int argc, char * argv[])
{
  typedef int                                   PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
  typedef itk::Image<float, ImageDimension>     OutputImageType;
  ...
  for (unsigned int i = 0; i < images.size(); i++)
  {
    ...
    for (it.GoToBegin(); !it.IsAtEnd(); ++it)
    {
      if (it.Value() > 0)
      {
        outimages[it.Value() - 1]->SetPixel(
          it.GetIndex(), outimages[it.Value() - 1]->GetPixel(it.GetIndex()) + 1.0f / static_cast<float>(images.size()));
      }
    }
  }
  for (int label = 1; label <= maxLabel; label++)
...
template <unsigned int ImageDimension>
int
CorrelationVoting(int argc, char * argv[])
{
  typedef float                                              PixelType;
  ...
  typename LabelImageType::Pointer output = AllocImage<LabelImageType>(images[0], 0);
  ...
  while (!it.IsAtEnd())
  {
    ...
    else
    {
      ...
      for (int i = 0; i < nImages; i++)
      {
        ...
        targetVar /= (k - 1);
        imageVar /= (k - 1);
        float pearson = (product - k * targetMean * imageMean) / ((k - 1) * std::sqrt(targetVar) * std::sqrt(imageVar));
...
template <unsigned int ImageDimension>
int
ImageMetrics(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
  ...
  {
    typedef itk::ANTSNeighborhoodCorrelationImageToImageMetricv4<ImageType, ImageType, ImageType> MetricType;
...
template <unsigned int ImageDimension>
int
PearsonCorrelation(int argc, char * argv[])
{
  typedef float                                        PixelType;
  typedef itk::Image<PixelType, ImageDimension>        ImageType;
  typedef itk::ImageRegionIteratorWithIndex<ImageType> IteratorType;
...
Project(int argc, char * argv[])
{
  ...
  unsigned int axis = std::stoi(argv[argct]);
  argct++;
  unsigned int which = std::stoi(argv[argct]);
  argct++;
...
TRealType
PatchCorrelation(itk::NeighborhoodIterator<TImageType> GHood,
                 itk::NeighborhoodIterator<TImageType> GHood2,
                 std::vector<unsigned int>             activeindex,
                 std::vector<TRealType>                weight,
                 ...
                 TInterp                               interp2)
{
  ...
  vnl_matrix<RealType>                                   grad1mat(Gsz, ImageDimension);
  grad1mat.fill(0);
  vnl_matrix<RealType> grad2mat(Gsz, ImageDimension);
  grad2mat.fill(0);
  // compute mean difference
  PointType avgpoint1;
  PointType avgpoint2;
  ...
  for (unsigned int ii = 0; ii < Gsz; ii++)
  {
    ...
    if ((IsInside<TGImageType>(gimage, gind)) && (IsInside<TGImageType>(gimage2, gind2)))
    {
      ...
      for (unsigned int jj = 0; jj < ImageDimension; jj++)
      {
        grad1mat(ii, jj) = grad1[jj];
        grad2mat(ii, jj) = grad2[jj];
      }
      PointType point1;
      PointType point2;
...
void
Sinkhorn(vnl_matrix<TRealType> & correspondencematrix)
{
...
template <typename TImage>
typename TImage::Pointer
ComputeLaplacianImage(typename TImage::Pointer input)
{
...
template <unsigned int ImageDimension>
int
PureTissueN4WeightMask(int argc, char * argv[])
{
...
template <unsigned int ImageDimension>
int
PMSmoothImage(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
...
template <unsigned int ImageDimension>
int
ConvolveImage(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
  ...
  std::string inputFileName = std::string(argv[argct]);
  argct++;
  std::string kernelFileName = std::string(argv[argct]);
  argct++;
...
InPaint(int argc, char * argv[])
{
  ...
  while (!imageIterator.IsAtEnd())
  {
    ...
    if (ct2 == static_cast<unsigned int>(std::floor(static_cast<float>(ct) / 2.0f)))
      imageIterator.Set(1.e-8);
    ++ct2;
    ++imageIterator;
  }
  imageIterator.GoToBegin();
...
template <unsigned int ImageDimension>
int
Check3TissueLabeling(int argc, char * argv[])
{
...
void
getBlobCorrespondenceMatrix(unsigned int             radval,
        ...
        for (unsigned int j = 0; j < blobs2.size(); j++)
        {
          ...
          if (image2->GetPixel(indexj) > smallval)
          {
            ...
            RealType correlation =
              PatchCorrelation<ImageDimension, RealType, ImageType, GradientImageType, InterpPointer>(
                GHood, GHood2, activeindex, weights, gimage, gimage2, interp2);
            if (correlation < 0)
            {
              correlation = 0;
            }
...
template <unsigned int ImageDimension>
int
BlobDetector(int argc, char * argv[])
{
  typedef float                                 PixelType;
  typedef float                                 RealType;
  typedef itk::Image<PixelType, ImageDimension> ImageType;
  ...
  std::string fn1 = std::string(argv[argct]);
  argct++;
  unsigned int nblobs = std::stoi(argv[argct]);
  argct++;
  std::string fn2 = "";
  if (argc > argct)
  {
  ...
  if (argc > argct)
  {
    corrthresh = atof(argv[argct]);
    argct++;
  }
  if (argc > argct)
  {
    radval = std::stoi(argv[argct]);
    argct++;
  }
  if (argc > argct)
  {
    dthresh = atof(argv[argct]);
    argct++;
  }
  typename ImageType::Pointer image;
  ...
  if ((!blobs2.empty()) && (!blobs1.empty()))
  {
    ...
    while ((matchpt < (corrthresh + 1)) && (count1 < blobs1.size()))
    {
      ...
      {
        if (static_cast<RealType>(std::fabs(bestblob->GetObjectRadius() - blob1->GetObjectRadius())) <
            maxradiusdiffallowed)
        {
...
MatchBlobs(int argc, char * argv[])
{
  ...
  std::string fn1 = std::string(argv[argct]);
  argct++;
  std::string landmarks1 = std::string(argv[argct]);
  argct++;
  std::string fn2 = std::string(argv[argct]);
  argct++;
  typename ImageType::Pointer image;
...
template <unsigned int ImageDimension>
int
KinematicTensor(int argc, char * argv[])
{
  if (argc < 5)
  {
    // std::cout << " Not enough inputs " << std::endl;
  ...
  enum StrainTensorType
  {
    DeformationFieldGradient = 0,
    Lagrangian,
    Eulerian,
